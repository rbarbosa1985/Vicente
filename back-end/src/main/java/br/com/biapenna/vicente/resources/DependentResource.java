...
import br.com.biapenna.vicente.services.DependentService;
...
public class DependentResource {
	...
	@GetMapping
	public ResponseEntity<Page<DependentDTO>> findAll(
		...
		Page<DependentDTO> list = service.findAllPaged(pageRequest);
		return ResponseEntity.ok().body(list);
	}
	
	@GetMapping(value= "/{id}")
	public ResponseEntity<DependentDTO> findById(@PathVariable Long id){
		DependentDTO guest = service.findById(id);
		return ResponseEntity.ok().body(guest);
	}
	
	@PostMapping
	public ResponseEntity<DependentDTO> insert (@Valid @RequestBody DependentDTO dto){
	...
	public ResponseEntity<DependentDTO> delete(@PathVariable Long id){
		service.delete(id);
